...
const PhotoCropper = (props) => {
    ...
    const { croppedAreaPixelsData, setCroppedAreaPixelsData, selectedImageData } = useContext(CollectionPhotoCropContext)
    ...
    return (
        <>
            ...
            <div style={{ position: 'relative', width: "500px", height:"500px" }}>
                <Cropper
                    image={selectedImageData ? selectedImageData.regular : props.testImage}
                    crop={crop}
                    zoom={zoom}
                    aspect={4 / 4}
